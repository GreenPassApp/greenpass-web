...
export class Regulation {
  ...
  constructor(validFrom: Date, rapidTestDuration: moment.Duration, PCRTestDuration: moment.Duration, validFromPartialVac: moment.Duration, validUntilPartialVac: moment.Duration, validUntilFullVac: moment.Duration) {
